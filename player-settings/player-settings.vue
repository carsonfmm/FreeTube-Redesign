    ...
    <ft-flex-box>
      ...
      <div class="settings-section">
        <ft-slider
          ...
          :disabled="rememberDefaultVolume ? true : false"
        />

        <ft-toggle-switch
          :label="('Remember Volume Setting From Player')"
          :compact="true"
          :default-value="rememberDefaultVolume"
          :tooltip="('When enabled, the volume last set in the video player is used as default. When disabled, \'Default Volume\' will be used.')"
          @change="updateRememberDefaultVolume"
        />
      </div>
