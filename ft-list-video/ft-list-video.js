...
export default Vue.extend({
  ...
  methods: {
    handleChannelsHidden: function(value, {messageOnSuccess = null, messageOnError = null}) {
      var fullList = this.$store.getters.getChannelsHidden
      fullList = JSON.parse(fullList)
      fullList.push(value)
      this.updateChannelsHidden(JSON.stringify(fullList))
    ...
    handleOptionsClick: function (option) {
      switch (option) {
        ...
        case 'openInvidiousChannel':
          ...
          break
        case 'blockChannel':
          //openBlockChannel(this.channelName, { messageOnSuccess: this.$t('Added channel '+this.channelName+' to the list of Hide Videos from Channels')})
          this.handleChannelsHidden(this.channelName, { messageOnSuccess: ('Added channel '+this.channelName+' to the list of Hide Videos from Channels') })
          break
      }
    },
